        ...
        >
            ...
            <div className="flex items-center gap-3">
                ...
                <button
                    ...
                    className="w-8 h-8 bg-amber-600 rounded-lg flex items-center justify-center text-white font-bold text-sm shadow-inner hover:scale-105 active:scale-95 transition-transform"
                >
